...
| Held-out measurement | ~6 min (13 unseen) | ~10 min (25 unseen) | ~11 min (23 unseen) | Identical everywhere: ask the unseen questions with the winner live, then restore V0 and ask the same questions again. The difference between those two scores is the run's reported result. Time simply scales with question count. |

...
| 3 Run the evolution job | ~14 min | ~26 min | ~3 h | Writes competing new skills (candidates), tests each by re-running all questions. Time = tests x 5-8 min. Lite: 2 tests (supervisor only). Standard: 3 tests. Full: system decides — up to 5 candidates x 3 agents x several rounds = dozens of tests, hence hours. |

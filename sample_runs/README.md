...
| [lite_deployed](lite_deployed/) | Cloud Run job vs the live stack, 13-question set (same as local lite), all models gemini-3.5-flash | ~33 min | V0 7.4% (27 real BigQuery sessions) -> winner 76.9% on the 13-question set; publish gate 10/10; PR #58 | — (deployed runs validate on their slice) |

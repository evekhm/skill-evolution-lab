...
| [lite_deployed](lite_deployed/) | Cloud Run job vs the live stack, BigQuery slice | ~91 min | PR #51: 21.8% -> 100.0%; in-container publish gate 10/10, PR checks all green | — (deployed runs validate on their slice) |

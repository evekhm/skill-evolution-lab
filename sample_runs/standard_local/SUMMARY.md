# Demo Run Summary — 2026-07-22_064300_demo_quick

- Wall time: 45m 10s
- BigQuery slice: `demo_run=2026-07-22_064300_demo_quick`
  (`EVOLUTION_TRACE_LABELS=demo_run=2026-07-22_064300_demo_quick bash scripts/test/show_traces.sh`)
...
|---|---|---|---|
| V0 baseline | 56.0% | 56.0% | 25/25 |
| v1 | 76.0% | 76.0% | 25/25 |
| candidate_1 | 80.0% | 80.0% | 25/25 |
| candidate_2 | 80.0% | 80.0% | 25/25 |
| candidate_3 | 80.0% | 80.0% | 25/25 |

## HELD-OUT RESULT (the headline: unseen questions)

| | V0 | Winner | Gain |
|---|---|---|---|
| Ground-truth rate | 48.0% | 76.0% | +28.0pp |

Winner previewed as PR: **v1 (80.0%)** -> pr_preview.md
Quality gate: winner 80.0% below the 95% threshold — another cycle is warranted
